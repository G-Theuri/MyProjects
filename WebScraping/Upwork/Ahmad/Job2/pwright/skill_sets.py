...
def run(playwright: Playwright) -> None:
    ...
    page.goto("https://training.gov.au/organisation/details/0022/summary")
    page.get_by_role("tab", name="Skill sets").click()
    ...
    new_file_path = os.path.join(download_path, "skill_sets.csv")
